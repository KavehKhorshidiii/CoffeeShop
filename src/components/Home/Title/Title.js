...
export default function Title() {
   return (
      <div className=" flex  items-center top-0">
         ...
         <div className=" right-6/10 max-w-1/3 space-y-1 md:space-y-3  items-end absolute flex  flex-col">
            ...
            <span className="text-xs md:text-xl text-right">قطعا نام اشنایه عربیکا را شنیده اید ، عربیکا یکی از گونه های قهوه است که در نواحی کختلف کمربند قهوه کشت میشود</span>
         </div>
