...
export default function Club() {
   return (
      <div className="coffeeClub mb-8 md:mb-20 px-11 flex flex-col-reverse xl:flex-row rounded-2xl h-80 xl:h-36 bg-linear-to-tr from-emerald-500 to-emerald-800">
        ...
        {/* Right section */}
         <div className=" justify-between items-center w-full xl:w-1/2 flex h-full">
            ...
            <div className="flex h-full gap-2 p-1 w-3/5 md:w-3/5 items-center">
               <div className=" bg-white rounded-2xl h-5/6 w-1/3 flex flex-col justify-center items-center">
