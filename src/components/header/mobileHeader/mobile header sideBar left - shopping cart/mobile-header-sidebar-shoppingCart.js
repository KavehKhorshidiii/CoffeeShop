...
export default function mobile_header_sidebar_shoppingCart({toggleLeftValue,toggleLeftHandler,}) {
   ...
   return (
      <div
         className={`${
            toggleLeftValue ? "translate-x-0" : "-translate-x-full "
      ...
      >
         ...
         <div className="h-fit pb-3 dark:border-white/50 border-black/50 border-b-1 flex items-center justify-between w-full">
            ...
            <ImCross
               onClick={() => toggleLeftHandler(!toggleLeftValue)}
            ...
            <div className="grid overflow-auto">
               <div className=" flex justify-between h-32 my-3.5 shadow-light dark:shadow-dark rounded-2xl ">
                  <div className=" p-2.5 flex w-2/3 flex-col  h-full justify-between">
                     <h1 className="flex text-sm text-zinc-700 dark:text-white font-bold justify-end text-right h-1/2 line-clamp-2">
                        قهوه اسپرسو مدل پرسیکا ۲۵۰ گرم{" "}
                     </h1>
         ...
         <div className="h-fit flex w-full justify-between border-t-2 border-white/10 pt-3">
            <button className=" hover:bg-teal-500 bg-teal-600 cursor-pointer rounded-2xl py-3.5 px-6">
               ثبت سفارش
            </button>
            <div className=" flex justify-center gap-1.5 text-right flex-col">
               <span className=" text-[10px] font-medium border-gray-300">
                  مبلغ قابل پرداخت
               </span>
