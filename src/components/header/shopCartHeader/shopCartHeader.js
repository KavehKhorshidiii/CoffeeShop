    ...
    return (
        ...
        <>
            ...
            <div className=" flex justify-between  w-full">
                <a className="flex text-sm items-center cursor-pointer tracking-tighter text-orange-300">
                    <MdOutlineArrowBackIos></MdOutlineArrowBackIos>مشاهده سبد
                    خرید
                </a>
            ...
            <div className="grid max-h-[50vh] overflow-auto">
                <div className=" flex justify-between h-32 my-3.5 shadow-light dark:shadow-dark rounded-2xl ">
                    <div className=" p-2.5 flex w-2/3 flex-col  h-full justify-between">
                        <h1 className="flex text-base text-zinc-700 dark:text-white font-bold justify-end text-right h-1/2 line-clamp-2">
