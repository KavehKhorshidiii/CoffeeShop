  ...
  return (
    ...
    {/* curt header */}
      ...
      <div className=" flex justify-between  w-full">
        ...
        <a className="flex text-sm items-center cursor-pointer tracking-tighter text-orange-300"><MdOutlineArrowBackIos></MdOutlineArrowBackIos>مشاهده سبد خرید</a>
      ...
      <div className=" flex justify-between h-32 my-3.5 shadow-light dark:shadow-dark rounded-2xl ">
        ...
        <div className=" p-2.5 flex w-2/3 flex-col  h-full justify-between">
            ...
            <div className="flex h-1/2 flex-col">
                <div className="flex  text-teal-600 justify-end gap-1.5 text-sm"><span>تخفیف</span><span>۱۴،۵۰۰ </span></div>
                <div className="flex justify-end gap-1.5"><span>تومان</span><span className=" font-bold text-lg">۳۵۰,۰۰۰</span></div>
            </div>
